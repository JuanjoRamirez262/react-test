  ...
  return (
    <div className="card text-center">
      ...
      <div className="card-body">
        ...
        <button className="btn btn-primary" type="button" onClick={handleClickIncrement}>
          Increment
        </button>
        <button className="btn btn-danger" type="button" onClick={handleClickDecrement}>
          Descrement
        </button>
        <button className="btn btn-success" type="button" onClick={handleClickReset}>
          Reset Counter
        </button>
      </div>
    </div>
